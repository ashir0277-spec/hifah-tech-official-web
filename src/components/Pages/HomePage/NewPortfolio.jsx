...
const projects = {
    "Mobile Apps": [
         ...
         {
            id: 'butcher-shop',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842882/ABU_RAFIK_BUTCHER_zmtlmz.png',
        ...
        {
            id: 'afroneta',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842887/AfroNeta_cpswek.png',
            title: 'AfroNeta',
            description: "AfroNeta streamlines users, content, payments, analytics, and community management.",
        },
        {
            id: 'anipartna',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842882/ANIATPNA_Mobile_App_yspt0j.png',
        ...
        {
            id: 'auravpn',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842882/Aura_VPN_n49mw5.png',
            title: 'aura VPN',
            description: "Fast, secure VPN powered by WireGuard and Supabase for private browsing.", 
        },
         {
            id: 'on-the-dot',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842888/Service_Booking_App_zi2i3n.png',
            title: 'service booking app',
            description: "Simplifies service discovery, booking, scheduling, and business management.", 
        },
        {
            id: 'revealit',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842886/Revealt_hpnmlu.png',
            title: 'revealit',
            description: "RevealIt scans products to explain ingredients, allergens, and safety insights.",
        },
        {
            id: 'noly',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842884/Noly_zajx8z.png',
            title: 'noly',
            description: "Noly converts audio into accurate transcripts and concise summaries.",
        },
        {
            id: 'gdrive',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842882/Gdrive_Final_rl26qk.png',
            title: 'GDrive',
            description: "Master the German driving exam with interactive quizzes, videos, and images.",    
        },
        {
            id: 'paktruck',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842885/PakTRuck_gngafd.png',
            title: 'pak truck',
            description: "Pak Truck simplifies buying, selling, and promoting trucks, buses, and spare parts.",
        },
        {
            id: 'blink-back',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842883/BlinkBack_rnjct0.png',
            title: 'blink back',
            description: "BlinkBack helps users capture and relive special moments with ease.",
        },
        {
            id: 'flaty',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842884/Flaty.pk_r8sxhu.png',
            title: 'Flaty.pk',
            description: "Flaty lets users buy, sell, and explore properties with trusted listings and secure transactions.", 
        },
        {
            id: 'meCloset',
            image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842884/MeCloset_kdtflk.png',
            title: 'Me Closet',
    ...
    description: "AI-powered wardrobe app for smart outfit curation, weekly style planning, and personalized fashion recommendations.",
        ...
        {
    id: 'safe-choice',
    image: 'https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842886/SafeChoice_nk72vp.png',
    title: 'SafeChoice',
...
{
    id: "mego",
    image: "https://res.cloudinary.com/dxsr1xve0/image/upload/v1783842885/Mego_cu6ids.png",
