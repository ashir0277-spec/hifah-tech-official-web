...
export default function JoinDropDown({ open }) {

  const coreServices = ["join as Team"];

  return (
    <div className={`absolute left-1/3.5 -translate-x-1/3 top-13 mt-3 transition-opacity duration-100 ${
        open ? "opacity-100 visible" : "opacity-0 invisible"
      }`}>
      <div className="absolute -top-2 left-3/8 -translate-x-1/2 w-4 h-4 bg-white rotate-45 border-l border-t border-[#33333322]" />
      ...
      <div className="w-[650px] mont bg-white shadow-[0_4px_50px_0px_rgba(0,0,0,0.1)] rounded-xl overflow-hidden border border-[#33333322] flex">
        ...
        <div
          ...
          style={{ width: '260px', minWidth: '220px', maxWidth: '260px', flexShrink: 0 }}
        >
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-xl sm:text-[24px] font-semibold text-black">Join Us</h3>
          </div>
          <p
