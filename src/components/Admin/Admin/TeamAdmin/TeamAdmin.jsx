  ...
  return (
      ...
      <div className="flex-1 overflow-y-auto">
        <div className=" w-full mx-auto">
          <h1 className="text-[24px] md:text-[32px] halant-bold  text-[#1E9994] flex items-center gap-2"><Menu onClick={toggleSidebar} className='w-5 h-5 cursor-pointer' /> Managed Team Members!</h1>
            ...
            {team.map(member => (
              ...
              >
                <div >
                  ...
                  <p className="text-[12px] text-gray-500 mt-1 mb-2 flex"><img src={clendericon} className='mr-2'/>Joined: {member.joiningDate.slice(0, 10)}</p>
                </div>
